...
// ✅ Join using owner_id instead of user_id
...
<title>Pending Orders - Peta Link</title>
...
<header>
  ...
  <div class="icons">
    <form method="GET" action="checkoutHistory.php" class="search-bar">
...
<div class="menu">
   <a href="checkoutPending.php" style="border-bottom: 3px solid red; text-decoration: none;">Pending</a>
...
<div class="picFlower">
  <div class="picOverlay">
    ...
    <p>Track your orders waiting to be shipped</p>
  </div>
</div>
