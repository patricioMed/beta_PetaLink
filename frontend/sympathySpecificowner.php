...
<header>
  ...
  <div class="icons">
    <form method="GET" action="sympathySpecificowner.php" class="search-bar">
...
<div class="navbar">
  ...
  <a style="border-bottom: 3px solid #5b2c6f; text-decoration: none;" href="sympathySpecificowner.php?owner_id=<?= $owner_id ?>">Sympathy</a>
  <a href="othersSpecificowner.php?owner_id=<?= $owner_id ?>">Others</a>
</div>

<div class="picFlower">
  <div class="picOverlay">
    <h1><?= $shopName ?> - Sympathy Collection</h1>
...
<div class="product-card">
  <a href="'.($row['availability'] == 1 ? 'details.php?id='.$id.'&category=Sympathy' : '#').'" 
  ...
  <div class="product-info">
    ...
    <a class="view-button" 
       href="'.($row['availability'] == 1 ? 'details.php?id='.$id.'&category=Sympathy' : '#').'" 
