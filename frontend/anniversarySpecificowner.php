...
<header>
  ...
  <div class="icons">
    <form method="GET" action="anniversarySpecificowner.php" class="search-bar">
...
<!-- Navigation -->
<div class="navbar">
  <a style="border-bottom: 3px solid #5b2c6f; text-decoration: none;" href="anniversarySpecificowner.php?owner_id=<?= $owner_id ?>">Anniversary</a>
...
<div class="picFlower">
  <div class="picOverlay">
    <h1><?= $shopName ?> - Anniversary Collection</h1>
...
<div class="product-card">
  <a href="'.($row['availability'] == 1 ? 'details.php?id='.$id.'&category=Anniversary' : '#').'" 
  ...
  <div class="product-info">
    ...
    <a class="view-button" 
       href="'.($row['availability'] == 1 ? 'details.php?id='.$id.'&category=Anniversary' : '#').'" 
