...
$result = $conn->query("SELECT id, name, email, contact_number, address FROM users WHERE role ='customer' ORDER BY id DESC");
$users = [];
...
<div class="main">
  ...
  <div class="container">
    <h1 style="margin-bottom:15px; color:#a81ea8ff;">Manage Customers</h1>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="actions">
              ...
              <button class="delete" onclick="openDeleteModal(<?= $row['id'] ?>)">Delete</button>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
...
<script>
  ...
  confirmBtn.addEventListener("click", function() {
    if (deleteId) {
      window.location.href = "manage_customers.php?delete=" + deleteId;
    }
  });
