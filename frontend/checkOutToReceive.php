...
$sql = "SELECT ch.flowerName, ch.quantity, ch.total, ch.payment_method, ch.status, ch.purchase_date, 
        ...
        WHERE ch.user_id = ? 
          AND (ch.status = 'Out for Delivery' OR ch.status = 'Pick Up')";
if (!empty($search)) {
    $sql .= " AND (
...
<div class="menu">
   <a href="checkoutHistory.php">Pending</a>
  <a href="checkoutPreparing.php">Preparing</a>
  <a href="checkoutToReceive.php" style="border-bottom: 3px solid red; text-decoration: none;">Pick-up/Out-for-Delivery </a>
