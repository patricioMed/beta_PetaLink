...
<header>
  ...
  <div class="icons">
    <form method="GET" action="birthdaySpecificowner.php" class="search-bar">
...
<div class="navbar">
  ...
  <a style="border-bottom: 3px solid #5b2c6f; text-decoration: none;" href="birthdaySpecificowner.php?owner_id=<?= $owner_id ?>">Birthday</a>
  <a href="valentinesSpecificowner.php?owner_id=<?= $owner_id ?>">Valentines</a>
...
<div class="picFlower">
  <div class="picOverlay">
    <h1><?= $shopName ?> - Birthday Collection</h1>
...
<div class="product-card">
  <a href="'.($row['availability'] == 1 ? 'details.php?id='.$id.'&category=Birthday' : '#').'" 
  ...
  <div class="product-info">
    ...
    <a class="view-button" 
       href="'.($row['availability'] == 1 ? 'details.php?id='.$id.'&category=Birthday' : '#').'" 
